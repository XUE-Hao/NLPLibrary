...
# optimizer = torch.optim.Adam(model.parameters(), lr=args.learning_rate, betas=(0.9, 0.999), eps=1e-08)  # TODO: 待同步
    ...
    for batch_id in range(1, len(train_batch_dataset)):
        ...
        if batch_id % args.log_batch_interval == 0:
            ...
            print('| epoch {:3d} | {:5d}/{:5d} batches | lr {:f} | ms/batch {:5.2f} | loss {:5.5f}'.format(
                epoch_id, batch_id, len(train_batch_dataset), args.learning_rate,
